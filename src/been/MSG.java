...
public class MSG {
	...
	/**
	 * @param sending_date the sending_date to set
	 */
	...
	/**
	 * @param receiving_date the receiving_date to set
	 */
	...
	/**
	 * @param is_received the is_received to set
	 */
	...
	/**
	 * @param is_seen the is_seen to set
	 */
